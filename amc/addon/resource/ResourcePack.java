...
public class ResourcePack {
    ...
    public ResourcePack(String icon_pack, String nama, String deskripsi, int[] versi, int[] min_engine_version) {
    ...
    public void create() {
      ...
      String folderName = nama + " - RP";
      Utility.buatFolder(folderName, "src/addon");

      String isiFileManifestRp = 
      "{\n" +
      " \"format_version\": 2,\n" +
      " \"header\": {\n" +
      ...
      Utility.buatFile("src/addon/" + folderName + "/manifest.json", isiFileManifestRp);
